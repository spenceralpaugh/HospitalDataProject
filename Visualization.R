        ...
        shinyApp(
                ...
                server = function(input, output){
                        output$weights = renderUI({
                                ...
                                sliderInput(paste0('w', i), paste0('Weights', i),
                                            value = 1/Dm,0,1)
                        })})
                       ...
                       output$Viz = renderPlot({
                               ...
                               par(mfrow=c(K,3))
                                for(k in 1:K){
                                        ...
                                        mtext(paste0('Mean Survival: ',round(colMeans(stats[clust$clustering ==k,9],na.rm=TRUE),2),' Days'),1)
